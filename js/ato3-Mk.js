...
//libera o "pegar o diario"
select5a.addEventListener('click', function() {
	mkiSelect5a.classList.remove('invisivel')
})

//libera o "pegar o papel"
select5b.addEventListener('click', function() {
	mkiSelect5b.classList.remove('invisivel')
})

//libera o "procurar no quarto" do "pegar o diario"
select6a1v1.addEventListener('click', function() {
	mkiSelect6a1.classList.remove('invisivel')
	mkiSelect6part2.classList.remove('invisivel')
	select6a1pre1.classList.remove('invisivel')
	mkiSelect6a1part2.classList.remove('invisivel')
})

//libera o "procurar na sala" do "pegar o diario"
select6b1v1.addEventListener('click', function() {
...
//libera o "não falar nada"
select6b2.addEventListener('click', function() {
 	mkiSelect6b2.classList.remove('invisivel')
})

//libera o "procurar no quarto" do "não falar nada"
select6a1v2.addEventListener('click', function() {
	mkiSelect6a1.classList.remove('invisivel')
	mkiSelect6part2.classList.remove('invisivel')
	select6a1pre2.classList.remove('invisivel')
	mkiSelect6a1part2.classList.remove('invisivel')
})

//libera o "procurar na sala" do "não falar nada"
select6b1v2.addEventListener('click', function() {
	mkiSelect6b1.classList.remove('invisivel')
	mkiSelect6part2.classList.remove('invisivel')
	select6a1pre2.classList.remove('invisivel')
	select6b1pre.classList.remove('invisivel')
	select6b1pre3.classList.remove('invisivel')
	mkiSelect6b1part2.classList.remove('invisivel')
})

// você vai resgatar a laura
select7ac1.addEventListener('click', function() {
	mkiSelect7ac1.classList.remove('invisivel')
})

//você não quer que a miko se machuque
...
//você vai com a Miko no resgate
...
var wOptA = document.querySelector('.w-optA') 
var wOptB = document.querySelector('.w-optB') 
var wOptionA = document.querySelector('.w-optionA') 
var wDialog1 = document.querySelector('.w-dialog1') 
var wDialog2 = document.querySelector('.w-dialog2') 

//prologo ato 4
var prologoAto4 = document.querySelector('.prologo-Ato4') 
var otherDialog = document.querySelector('.other-dialog') 
var dialogNormal = document.querySelector('.dialog-normal')
...
//perguntar para a Miko
seqA.addEventListener('click', function() {
	sequenceA.classList.remove('invisivel')
	prologoAto4.classList.remove('invisivel')
	dialogNormal.classList.remove('invisivel')
	botao.classList.remove('invisivel')
	rodape.classList.remove('invisivel')
})

//deixar quieto
seqB.addEventListener('click', function() {
	sequenceB.classList.remove('invisivel')
	prologoAto4.classList.remove('invisivel')
	dialogNormal.classList.remove('invisivel')
	botao.classList.remove('invisivel')
	rodape.classList.remove('invisivel')
...
wOptA.addEventListener('click', function() {
	...
	if (mkiSelect7b2.classList.contains('invisivel') == false) {
		...
		prologoAto4.classList.remove('invisivel')
		otherDialog.classList.remove('invisivel')
		botao.classList.remove('invisivel')
		rodape.classList.remove('invisivel')
	}
})
